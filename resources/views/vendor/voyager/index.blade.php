            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="panel widget center bgimage"
                    ...
                    <div class="panel-content">
                        <i class="{{ $user['dt']->icon }}"></i>
                        <h4>{{ $user['count'] }} {{ $user['dt']->display_name_plural }}</h4>
                        <p>You have {{ $user['count'] }} users in your database. Click on button below to view all users.
                        </p>
                        <a href="http://127.0.0.1:8000/admin/users" class="btn btn-primary">View all users</a>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="panel widget center bgimage"
                    ...
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        <i class="{{ $post['dt']->icon }}"></i>
                        <h4>{{ $post['count'] }} {{ $post['dt']->display_name_plural }}</h4>
                        <p>You have {{ $post['count'] }} posts in your database. Click on button below to view all posts.
                        </p>
                        <a href="http://127.0.0.1:8000/admin/posts" class="btn btn-primary">View all posts</a>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="panel widget center bgimage"
                    ...
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        <i class="{{ $article['dt']->icon }}"></i>
                        <h4>{{ $article['count'] }} {{ $article['dt']->display_name_plural }}</h4>
                        <p>You have {{ $article['count'] }} articles in your database. Click on button below to view all
                            article.
                        </p>
                        <a href="http://127.0.0.1:8000/admin/articles" class="btn btn-primary">View all articles</a>
                    </div>
                </div>
            </div>
        </div>
